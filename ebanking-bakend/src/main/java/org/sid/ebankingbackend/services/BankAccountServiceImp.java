...
public class BankAccountServiceImp implements BankAccountService {
    ...
    public List<AccountOperationDTO> accountHistory(String accountId) {
        List<AccountOperation> accountOperations = accountOpperationRepository.findByBankAccountId(accountId);
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        Page<AccountOperation> accountOperations = accountOpperationRepository.findByBankAccountIdOrderByOperationDateDesc(accountId, PageRequest.of(page, size));
